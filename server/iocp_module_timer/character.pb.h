...
// required string chat = 2;
inline bool Player::has_chat() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Player::set_has_chat() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Player::clear_has_chat() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Player::clear_chat() {
  chat_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_chat();
}
inline const ::std::string& Player::chat() const {
...
inline void Player::set_chat(const ::std::string& value) {
  set_has_chat();
...
inline void Player::set_chat(const char* value) {
  set_has_chat();
...
inline void Player::set_chat(const char* value, size_t size) {
  set_has_chat();
...
inline ::std::string* Player::mutable_chat() {
  set_has_chat();
...
inline ::std::string* Player::release_chat() {
  clear_has_chat();
  return chat_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Player::set_allocated_chat(::std::string* chat) {
  if (chat != NULL) {
    set_has_chat();
  } else {
    clear_has_chat();
