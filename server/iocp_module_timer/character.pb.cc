...
void protobuf_AssignDesc_character_2eproto() {
  ...
  static const int Player_offsets_[2] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Player, chat_),
  };
  Player_reflection_ =
...
const int Player::kChatFieldNumber;
#endif  // !_MSC_VER

Player::Player()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Character.Player)
}
...
Player::Player(const Player& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Character.Player)
}
...
Player::~Player() {
  // @@protoc_insertion_point(destructor:Character.Player)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Character.Player)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Character.Player)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Character.Player)
  return false;
#undef DO_
}
...
void Player::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Character.Player)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:Character.Player)
}

::google::protobuf::uint8* Player::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Character.Player)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Character.Player)
  return target;
}
...
void Player::clear_name() {
 ...
 const ::std::string& Player::name() const {
  // @@protoc_insertion_point(field_get:Character.Player.name)
  return name_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Player::set_name(const ::std::string& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Character.Player.name)
}
 void Player::set_name(const char* value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Character.Player.name)
}
 void Player::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Character.Player.name)
}
 ::std::string* Player::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:Character.Player.name)
 ...
 void Player::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Character.Player.name)
}

// required string chat = 2;
bool Player::has_chat() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void Player::set_has_chat() {
  _has_bits_[0] |= 0x00000002u;
}
void Player::clear_has_chat() {
  _has_bits_[0] &= ~0x00000002u;
}
void Player::clear_chat() {
  chat_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_chat();
}
 const ::std::string& Player::chat() const {
  // @@protoc_insertion_point(field_get:Character.Player.chat)
  return chat_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Player::set_chat(const ::std::string& value) {
  set_has_chat();
  chat_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Character.Player.chat)
}
 void Player::set_chat(const char* value) {
  set_has_chat();
  chat_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Character.Player.chat)
}
 void Player::set_chat(const char* value, size_t size) {
  set_has_chat();
  chat_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Character.Player.chat)
}
 ::std::string* Player::mutable_chat() {
  set_has_chat();
  // @@protoc_insertion_point(field_mutable:Character.Player.chat)
  return chat_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* Player::release_chat() {
  clear_has_chat();
  return chat_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Player::set_allocated_chat(::std::string* chat) {
  if (chat != NULL) {
    set_has_chat();
  } else {
    clear_has_chat();
  ...
  // @@protoc_insertion_point(field_set_allocated:Character.Player.chat)
}
